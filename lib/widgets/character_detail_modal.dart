    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _InfoRow(label: 'Height', value: character.heightInMeters, icon: Icons.height),
          _InfoRow(label: 'Mass', value: character.massInKg, icon: Icons.monitor_weight_outlined),
          _InfoRow(label: 'Birth Year', value: character.birthYear, icon: Icons.cake_outlined),
          _InfoRow(label: 'Added to API', value: character.formattedCreatedDate, icon: Icons.calendar_today_outlined),
          _InfoRow(
            label: 'Films',
